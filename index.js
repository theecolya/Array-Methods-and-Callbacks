...
function getHomeTeam(array) {
    let obj = array.filter(year => { return year['Year'] === 2014 && year['Stage'] === 'Final' });
...
function getHomeGoals(array) {
    let obj = array.filter(year => { return year['Year'] === 2014 && year['Stage'] === 'Final' });
    return obj[0]['Home Team Goals']
  }
  console.log(getHomeGoals(fifaData))
//(d) Away Team goals for 2014 world cup final
function getAwayGoals(array) {
    let obj = array.filter(year => { return year['Year'] === 2014 && year['Stage'] === 'Final' });
    return obj[0]['Away Team Goals']
  }
  console.log(getAwayGoals(fifaData))
//(e) Winner of 2014 world cup final */
function getWinner(array) {
    let obj = array.filter(year => { return year['Year'] === 2014 && year['Stage'] === 'Final' });
    return obj[0]['Win conditions']
  }
